...
const (
	FinalizerString = "finalizers.acm.services.k8s.aws/AcmeExternalAccountBinding"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("acmeexternalaccountbindings")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AcmeExternalAccountBinding{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AcmeExternalAccountBinding),
	}
}
